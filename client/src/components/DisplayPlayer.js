                ...
                <div className='border border-primary d-flex col align-items-center justify-content-center'>
                    <div className='d-flex justify-content-center'>
                        ...
                        <div>
                            ...
                            <div className='h6 text-secondary'>69 LP</div>
